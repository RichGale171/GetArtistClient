...
{
    ServiceReference1.ShowInfoServiceClient stsc = new ServiceReference1.ShowInfoServiceClient();
    ...
    protected void VenueByShowButton_Click(object sender, EventArgs e)
    {
        ...
        ServiceReference1.ShowInfo[] show = stsc.GetShowByVenue(venue);
    ...
    protected void ArtistByShowButton_Click(object sender, EventArgs e)
    {
        ...
        ServiceReference1.ShowInfo[] show = stsc.GetShowByArtist(artist);
